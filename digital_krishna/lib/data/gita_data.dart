...
final List<Verse> gitaVerses = [
  ...
  Verse(
    chapter: 2,
    verse: 63,
    text: "क्रोधाद्भवति सम्मोहः सम्मोहात्स्मृतिविभ्रमः। स्मृतिभ्रंशाद् बुद्धिनाशो बुद्धिनाशात्प्रणश्यति॥",
    translation: "From anger comes complete delusion, and from delusion bewilderment of memory. When memory is bewildered, intelligence is lost, and when intelligence is lost one falls down again into the material pool.",
  ...
  Verse(
    ...
    transliteration: "ananyāśh chintayanto māṁ ye janaḥ paryupāsate...",
  ),
  Verse(
    chapter: 10,
    verse: 20,
    text: "अहमात्मा गुडाकेश सर्वभूताशयस्थितः। अहमादिश्च मध्यं च भूतानामन्त एव च॥",
    translation: "I am the Super Soul, O Arjuna, seated in the hearts of all living entities. I am the beginning, the middle and the end of all beings.",
    transliteration: "aham ātmā guḍākeśha sarva-bhūtāśhaya-sthitaḥ...",
  ),
  Verse(
    chapter: 12,
    verse: 13,
    text: "अद्वेष्टा सर्वभूतानां मैत्रः करुण एव च। निर्ममो निरहंकारः समदुःखसुखः क्षमी॥",
  ...
  Verse(
    ...
    translation: "Wherever there is Kṛṣṇa, the master of all mystics, and wherever there is Arjuna, the supreme archer, there will also certainly be opulence, victory, extraordinary power, and morality.",
    transliteration: "yatra yoga-īśhvaraḥ kṛiṣhṇo yatra pārtho dhanur-dharaḥ...",
  ),
];
